...
global.email ="admin@gilbertkyalotech.co.ke"
global.location="Karatina,Kenya."
...
global.github=process.env.GITHUB|| "https://github.com/Gilbertkyalo/gilbert-bot-md";
...
global.devs = "254795443901" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "admin";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "254795443901";
...
global.scan = "https://qr-scan.gilbertkyalotech.co.ke/";
...
module.exports = {
  ...
  ownername:process.env.OWNER_NAME|| "It's Gilberttech",
  ...
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : "GILBERT",
